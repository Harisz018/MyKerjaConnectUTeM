...
<div class="dashboard-header">
    ...
    <h2 id="adminName">Welcome, <?php echo htmlspecialchars($admin_name); ?></h2>
</div>
        ...
        <table class="application-table">
            ...
            if ($users_result->num_rows > 0) {
                while($row = $users_result->fetch_assoc()) {
                    ...
                    echo "<td>
                            <a href='admin-dashboard.php?delete_user=" . $row['id'] . "' class='apply-btn' style='background-color:#dc3545; padding: 5px 10px; text-decoration:none; font-size:0.85rem;' onclick='return confirm(\"Are you sure?\");'>Delete</a>
                          </td>";
                    echo "</tr>";
                }
            }
        ...
        <table class="application-table">
            ...
            if ($jobs_result->num_rows > 0) {
                while($row = $jobs_result->fetch_assoc()) {
                    ...
                    echo "<td>" . htmlspecialchars($row['status']) . "</td>";
                    echo "<td>
                            <a href='admin-dashboard.php?delete_job=" . $row['job_id'] . "' class='apply-btn' style='background-color:#dc3545; padding: 5px 10px; text-decoration:none; font-size:0.85rem;' onclick='return confirm(\"Remove this vacancy?\");'>Remove</a>
                          </td>";
                    echo "</tr>";
                }
            } else {
